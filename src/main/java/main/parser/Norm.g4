...
prohibition: 'norm' LPAREN INTEGER ',' 'prohibition' ',' ROLE ',' NAME ',' activationCondition ',' expirationCondition ',' violatedCondition RPAREN;
...
violatedCondition: tuple (LOGICAL_OPERATOR tuple)*;
